...
public class Migrator {
    ...
    private static UpdateOneModel<Document> transformRating(Document doc) {
        try {
            ...
            return new UpdateOneModel<Document>(
                    eq("_id", doc.getObjectId("_id")), set("imdb.rating", rating));
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://bielu:bielu@sandbox.wmvol.mongodb.net/test?authSource=admin&replicaSet=atlas-xfvi88-shard-0&readPreference=primary&ssl=true";
